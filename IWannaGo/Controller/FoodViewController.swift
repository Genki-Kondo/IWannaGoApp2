...
class FoodViewController: UIViewController,CLLocationManagerDelegate {
    ...
    func showMap(){
        ...
        //YOLPのAPIを送信し地図を表示する
        let urlString = "https://map.yahooapis.jp/search/local/V1/localSearch?"+"&lat="+latitudeNow+"&lon=" + longitudeNow+"&gc="+selectedFoodDetail+randomFoodGc+"&maxprice=" + maxMoney + "&sort="+selectedShowType + "&parking="+parking+"&results=30&appid=dj00aiZpPVBHOVBCb0daWTZXRSZzPWNvbnN1bWVyc2VjcmV0Jng9Y2M-&output=json"
